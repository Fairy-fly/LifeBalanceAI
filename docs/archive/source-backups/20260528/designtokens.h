...
#ifdef Q_OS_ANDROID
inline constexpr int MotionAndroidDialog = 100;
inline constexpr int MotionAndroidPage = 180;
inline constexpr int MotionAndroidExpand = 300;
#endif
...
inline QString dietColor() { return color("#F09070"); }
inline QString dietLight() { return color("#F5B0A0"); }
